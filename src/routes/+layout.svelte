...
<div class="relative h-[100dvh]">
    ...
    <AppShell>
        <svelte:fragment slot="header">
            <navbar class="absolute top-0 flex h-[4.5rem] w-full items-center justify-between bg-surface-900/90 px-[3vw] backdrop-blur-3xl md:static md:h-[10vh] md:py-[0.9375vw] md:pl-[2.1vw] md:pr-[3.75vw]">
