...
<div class="px-[5vw] md:p-[1.25vw] md:pr-[3.75vw]">
    <div class="flex justify-between">
        ...
        <latest-episodes class="w-[21.5625vw] hidden md:block">
        ...
        <navigation-card
            class="relative hidden md:block mt-[3.4vw] h-[24.1325vw] w-[16.625vw] rounded-[0.875vw] bg-cover bg-center"
