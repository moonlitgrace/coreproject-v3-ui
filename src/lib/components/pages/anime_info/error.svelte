...
<section class="grid h-full grid-cols-5 items-end justify-between md:px-[5vw]">
    <radial-gradient
        class="pointer-events-none absolute bottom-0 right-0 z-10 md:h-[50vw] md:w-[50vw]"
        style="background-image: radial-gradient(circle at center, rgba(117, 105, 225, 0.1) 0%, transparent 75%);"
    />
