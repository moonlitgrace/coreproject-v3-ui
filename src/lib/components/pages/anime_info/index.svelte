                        ...
                        <div class="mt-4 grid grid-cols-12 gap-5 md:mt-[2.5vw] md:gap-[2.5vw]">
                            {#each anime_episodes as episode}
                                ...
                                >
                                    ...
                                    <episode-info-card class="relative col-span-7 flex h-full w-full flex-col items-start justify-between md:absolute md:bottom-0 md:col-span-12 md:max-h-[8vw] md:rounded-b-[0.625vw] md:bg-surface-900 md:p-[1vw] md:duration-300 md:hover:transition-max-height md:group-hover:max-h-[10vw]">
