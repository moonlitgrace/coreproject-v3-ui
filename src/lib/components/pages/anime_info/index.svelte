            ...
            <anime-main-infos class="grid grid-cols-12 items-end justify-between">
                <anime-titles class="relative col-span-12 grid grid-cols-12 gap-5 md:col-span-7 md:flex md:w-full md:items-end md:gap-[2vw] md:pr-[2vw]">
                    <anime-banner class="relative col-span-12 h-96 md:h-[18.25vw] md:w-[13vw] md:flex-shrink-0">
                        <radial-gradient class="pointer-events-none absolute inset-0 z-10 h-[150%] w-[125%] -translate-x-8 -translate-y-28 [background-image:radial-gradient(circle_at_center,_rgba(255,255,255,0.1)_0%,_transparent_100%)] [mask-image:linear-gradient(to_bottom,rgba(7,5,25,0.95)_80%,rgba(0,0,0,0)_100%)] md:hidden" />
                        <ImageLoader
